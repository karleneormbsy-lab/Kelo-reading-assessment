...
const LEVEL_INFO: Record<number, {
  ...
  1: {
    ...
    lessons: [
      { id: 'lesson-l1-01', num: 1,  title: 'Short /a/ Sound',       phonogram: 'a',  unlocked: true,  completed: true  },
      { id: 'lesson-l1-02', num: 2,  title: 'Short /i/ Sound',        phonogram: 'i',  unlocked: true,  completed: true  },
      { id: 'lesson-l1-03', num: 3,  title: 'Short /o/ Sound',        phonogram: 'o',  unlocked: true,  completed: true  },
      { id: 'lesson-l1-04', num: 4,  title: 'Short /u/ Sound',        phonogram: 'u',  unlocked: true,  completed: false },
      { id: 'lesson-l1-05', num: 5,  title: 'Short /e/ Sound',        phonogram: 'e',  unlocked: false, completed: false },
      { id: 'lesson-l1-06', num: 6,  title: 'CVC Words – Set 1',      phonogram: 'CVC', unlocked: false, completed: false },
      { id: 'lesson-l1-07', num: 7,  title: 'CVC Words – Set 2',      phonogram: 'CVC', unlocked: false, completed: false },
      { id: 'lesson-l1-08', num: 8,  title: 'Blending Practice',      phonogram: 'blend', unlocked: false, completed: false },
      { id: 'lesson-l1-09', num: 9,  title: 'Segmenting Practice',    phonogram: 'seg',   unlocked: false, completed: false },
      { id: 'lesson-l1-10', num: 10, title: 'Review – All Short Vowels', phonogram: 'a,e,i,o,u', unlocked: false, completed: false },
    ],
  },
  2: {
    ...
    lessons: [
      ...
      { id: 'lesson-l2-04', num: 4,  title: 'The /wh/ Digraph',   phonogram: 'wh', unlocked: false, completed: false },
      { id: 'lesson-l2-05', num: 5,  title: 'Double /ff/ & /ll/', phonogram: 'ff,ll', unlocked: false, completed: false },
      { id: 'lesson-l2-06', num: 6,  title: 'Double /ss/ & /ck/', phonogram: 'ss,ck', unlocked: false, completed: false },
      { id: 'lesson-l2-07', num: 7,  title: 'Digraph Review',     phonogram: 'digraphs', unlocked: false, completed: false },
    ],
  },
  3: {
    title: 'Long Vowels', icon: '⭐', color: 'from-purple-400 to-violet-500', focus: 'Silent e, ai, ay, ea, ee, oa',
    lessons: [
      { id: 'lesson-l3-01', num: 1, title: 'Silent-e – a_e',    phonogram: 'a_e', unlocked: false, completed: false },
      { id: 'lesson-l3-02', num: 2, title: 'Silent-e – i_e',    phonogram: 'i_e', unlocked: false, completed: false },
      { id: 'lesson-l3-03', num: 3, title: 'Silent-e – o_e',    phonogram: 'o_e', unlocked: false, completed: false },
      { id: 'lesson-l3-04', num: 4, title: 'Vowel Team ai/ay',  phonogram: 'ai,ay', unlocked: false, completed: false },
      { id: 'lesson-l3-05', num: 5, title: 'Vowel Team ea/ee',  phonogram: 'ea,ee', unlocked: false, completed: false },
      { id: 'lesson-l3-06', num: 6, title: 'Vowel Team oa/ow',  phonogram: 'oa,ow', unlocked: false, completed: false },
    ],
  },
  4: {
    title: 'Syllables', icon: '🚀', color: 'from-orange-400 to-amber-500', focus: 'Open/closed syllables, suffixes',
    lessons: [
      { id: 'lesson-l4-01', num: 1, title: 'Closed Syllables',      phonogram: 'CVC', unlocked: false, completed: false },
      { id: 'lesson-l4-02', num: 2, title: 'Open Syllables',        phonogram: 'CV',  unlocked: false, completed: false },
      { id: 'lesson-l4-03', num: 3, title: 'Suffix -ing',           phonogram: '-ing', unlocked: false, completed: false },
      { id: 'lesson-l4-04', num: 4, title: 'Suffix -ed',            phonogram: '-ed',  unlocked: false, completed: false },
      { id: 'lesson-l4-05', num: 5, title: 'Two-Syllable Words',    phonogram: '2-syl', unlocked: false, completed: false },
    ],
  },
  5: {
    title: 'Advanced', icon: '🌟', color: 'from-red-400 to-rose-500', focus: 'Prefixes, suffixes, roots',
    lessons: [
      { id: 'lesson-l5-01', num: 1, title: 'Prefix un-',     phonogram: 'un-',  unlocked: false, completed: false },
      { id: 'lesson-l5-02', num: 2, title: 'Prefix re-',     phonogram: 're-',  unlocked: false, completed: false },
      { id: 'lesson-l5-03', num: 3, title: 'Prefix pre-',    phonogram: 'pre-', unlocked: false, completed: false },
      { id: 'lesson-l5-04', num: 4, title: 'Suffix -tion',   phonogram: '-tion', unlocked: false, completed: false },
      { id: 'lesson-l5-05', num: 5, title: 'Greek/Latin Roots', phonogram: 'roots', unlocked: false, completed: false },
    ],
  },
  6: {
    title: 'Mastery', icon: '🏆', color: 'from-yellow-400 to-amber-400', focus: 'Multisyllabic words, fluency',
    lessons: [
      { id: 'lesson-l6-01', num: 1, title: 'Multisyllabic Decoding', phonogram: 'multi', unlocked: false, completed: false },
      { id: 'lesson-l6-02', num: 2, title: 'Fluency Building',       phonogram: 'fluency', unlocked: false, completed: false },
      { id: 'lesson-l6-03', num: 3, title: 'Advanced Vocabulary',    phonogram: 'vocab',   unlocked: false, completed: false },
      { id: 'lesson-l6-04', num: 4, title: 'Mastery Assessment',     phonogram: 'assess',  unlocked: false, completed: false },
    ],
  },
}
              ...
              {lesson.unlocked ? (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 text-sm">Phonogram: {lesson.phonogram}</p>
                  </div>
